...
export default function Mobile() {
    ...
    return (
        <div>
            <div className="MobileLandingContainer">
                <h1>Know <span style={{color: '#ff0000'}}>before</span> it happens</h1>
                <h3 className="MobileSubHeading">Get alerts of potential incidents</h3>
                <button className='MobileAddNumber' onClick={() => setOpen(true)}>
                    Add Phone Number
                </button>
            </div>
            ...
            >
                <Box sx={{
                    ...
                    <button className='MobileNumberAdd' onClick={() => submit()} style={{marginTop: '20px'}}>
                        Submit
                    </button>
                </Box>
            </Modal>
